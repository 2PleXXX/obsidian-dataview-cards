// ╭────────────────────────────────────────────────────────────╮
// │  Script by pleXXX (💬 Telegram: t.me/sad2plexxx)           │
...
function runUniversalCards(dv, inputConfig = {}) {
  ...
  async function checkForScriptUpdates(dv, t) {
    const VERSION_INFO_URL =
      "https://raw.githubusercontent.com/2PleXXX/obsidian-dataview-cards/refs/heads/main/version.json"; // сравнение версий
    const GITHUB_REPOSITORY =
      "https://github.com/2PleXXX/obsidian-dataview-cards"; // ссылка на репозиторий
    const SCRIPT_FILE_URL =
      "https://github.com/2PleXXX/obsidian-dataview-cards"; // ссылка на файл скрипта
